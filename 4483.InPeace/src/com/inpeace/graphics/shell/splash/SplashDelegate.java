 ...
 * @since   20 Mar 2014
 */
public class SplashDelegate extends BackgroundPanel implements AbstractView {

	/** Eclipse generated version ID.  */
	private static final long serialVersionUID = 7655251010645403383L;
	
	/**   */
	private GraphicsManager controller;
	 ...
	 * @param relativePath
	 */
	public SplashDelegate(GraphicsManager controller) {
	...
	public void run() {
		...
		controller.setState(new MainMenuDelegate(controller));
	}
